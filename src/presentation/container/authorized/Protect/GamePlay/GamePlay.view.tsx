...
import { BACKGROUND_GAME_SHOOTTHESCREW, FRAME_AVATAR_LEFT, FRAME_AVATAR_RIGHT, FRAME_TIME, ICON_VS, FRAME_GAME_PROTECT, ICON_DRILL, FRAME_ACESSSORRY, ICON_PROTECT_1, ICON_PROTECT_2, ICON_PROTECT_3 } from '../../../../../../assets';
...
const _GamePlayProtect: React.FC = ({route}: any) => {
    ...
    const icons = [
        { icon: ICON_PROTECT_1, width: scaleWidth(84.71), height: scaleHeight(60.35) },
        { icon: ICON_PROTECT_2, width: scaleWidth(69.13), height: scaleHeight(46.32) },
        { icon: ICON_PROTECT_3, width: scaleWidth(69.13), height: scaleHeight(46.32) }
    ];
        ...
        <ImageBackground source={BACKGROUND_GAME_SHOOTTHESCREW} style={styles.background} resizeMode="stretch">
            ...
            <TouchableWithoutFeedback onPress={handleTouch}>
                <ImageBackground source={FRAME_GAME_PROTECT} style={styles.frameGame} resizeMode='stretch'>
                    ...
                    {showMessage && (
                        <Text style={styles.message}>SIÊU CHỐNG ẨM</Text>
                    )}
                </ImageBackground>
